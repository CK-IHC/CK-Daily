...
var SHEET_SCHEMAS = {
  ...
  OrderItems: ['item_id', 'order_id', 'order_no', 'product_id', 'category_id', 'sku', 'product_name', 'options_json', 'unit_price', 'qty', 'line_total', 'note', 'created_at', 'updated_at', 'is_deleted'],
